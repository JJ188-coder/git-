...
- `ZCODE.md` - global rules (engineering, git workflow, auto-sync policy, OCR defaults, new-project-new-repo rule)
...
See ZCODE.md "Known Project Repos" section for the authoritative list.
